...
const defaults = {
	og: {
		image: `https://${config.domainName}/twitter-image.png`,
	},
}
...
export const getSEOTags = ({
	...
	return {
		...
		title: title ? `${title} | ${brandName}` : config.appName,
		...
		twitter: {
			...
			images: openGraph?.images ?? [defaults.og.image],
		...
		<script
			...
			dangerouslySetInnerHTML={{
				__html: JSON.stringify({
					...
					image: `https://${config.domainName}/linkfluencer-logo.png`,
